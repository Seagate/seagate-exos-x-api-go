...
// checks if the VolumesResourceInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumesResourceInner{}
...
func (o VolumesResourceInner) ToMap() (map[string]interface{}, error) {
