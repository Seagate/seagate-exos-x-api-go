...
func Test_client_DefaultApiService(t *testing.T) {
	...
	t.Run("Test DefaultApiService ShowControllerDateGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.DefaultApi.ShowControllerDateGet(context.Background()).Execute()
