...
func (s *Specification) GenerateLogin(ctx context.Context) error {
	...
	s.Resources(6, "type: string")
	s.Resources(6, "description: Indicates whether the command returned a success, failure, or informational message")
	s.Resources(5, "response-type-numeric:")
	s.Resources(6, "type: integer")
	s.Resources(6, "description: Indicates whether the command returned a success, failure, or informational message( In numeric form )")
